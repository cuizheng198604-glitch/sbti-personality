...
const ANIMAL_CONFIG = {
  ...
  questions: [
    ...
    { section:"MBTI · 能量倾向", type:"mbti", dim:"E", text:"别人对你的第一印象通常是？", opts:[{l:"A",t:"气场很强，一看就不是普通人",s:5},{l:"B",t:"温暖亲切，让人想亲近",s:4},{l:"C",t:"高冷神秘，想进一步了解",s:2},{l:"D",t:"呆萌可爱，没有攻击性",s:1}]},
  ...
  traffic: {
    enabled: true,
    showMode: "resultOnly",
    entries: [{ name:"微信公众号", icon:"📮", title:"扫码加我微信", desc:"备注【动物】获取完整性格报告", qrCode:"wechat-qr.png", url:"" }]
  },
