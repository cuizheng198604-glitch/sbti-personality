...
(function () {
  ...
  const I18N = {
    ...
    'result_analysis': { zh: '详细解读', en: 'Detailed Analysis' },
  'result_share': { zh: '分享你的动物人格', en: 'Share Your Animal Personality' },
    ...
    'result_cta': { zh: '你的动物人格是什么？敢不敢来测？ 👉', en: "What's your animal personality? Dare to try? 👉" },
  ...
  function t(key) {
    var dict = I18N[key];
    if (!dict) {
      // Fallback: check window.I18N for extra keys (added after init)
      var extra = window.I18N && window.I18N[key];
      if (extra) return extra[currentLang] || extra.zh || key;
      return key;
    }
  ...
  window.I18N = {
    ...
    'appreciate_desc': { zh: '您的支持是我持续优化的动力', en: "Your support drives me forward" },
    'appreciate_share_hint': { zh: '点击测试结果页右上角「分享」给朋友也是支持 🙏', en: "Sharing with friends from the result page also helps 🙏" },
    'appreciate_thanks': { zh: '感谢您的支持 🙏', en: "Thank you for your support 🙏" },
    'appreciate_title': { zh: '请我喝杯咖啡', en: "Buy Me a Coffee" },
    'benefit_17_types': { zh: '17种动物性格详解', en: "17 Animal Types Explained" },
    'benefit_full_analysis': { zh: '完整版动物人格分析', en: "Full Animal Personality Analysis" },
    'benefit_match_index': { zh: '动物配对指数查询', en: "Animal Match Index Query" },
    'benefit_mbti_bf': { zh: 'MBTI + BigFive 详细报告', en: "MBTI + BigFive Detailed Report" },
    'btn_login': { zh: '登录', en: "Login" },
    'btn_register': { zh: '注册', en: "Register" },
    'btn_submit_comment': { zh: '发布留言', en: "Post Comment" },
    'comment_load_failed': { zh: '加载失败', en: "Failed to load" },
    'comment_login_prompt': { zh: '登录后可留言', en: "Login to comment" },
    'comment_or': { zh: '或', en: "or" },
    'comment_placeholder': { zh: '分享你的测试感受...', en: "Share your thoughts about the test..." },
    'comment_title': { zh: '留言板', en: "Comments" },
    'err_fill_account': { zh: '请填写账号和密码', en: "Please fill in account and password" },
    'err_login_failed': { zh: '登录失败', en: "Login failed" },
    'err_network': { zh: '网络错误', en: "Network error" },
    'feat_daily_gacha': { zh: '每日抽卡', en: "Daily Gacha" },
    'feat_relationship': { zh: '关系配对', en: "Relationship" },
    'feat_retake': { zh: '重新测试', en: "Retake Test" },
    'form_account': { zh: '账号', en: "Account" },
    'form_city': { zh: '城市', en: "City" },
    'form_gender': { zh: '性别', en: "Gender" },
    'form_name': { zh: '姓名', en: "Name" },
    'form_password': { zh: '密码', en: "Password" },
    'form_phone': { zh: '手机', en: "Phone" },
    'form_qq': { zh: 'QQ', en: "QQ" },
    'form_required_hint': { zh: '* 为必填项，其他信息选填', en: "* Required, others optional" },
    'form_wechat': { zh: '微信', en: "WeChat" },
    'login_placeholder_account': { zh: '输入账号', en: "Enter account" },
    'login_placeholder_password': { zh: '输入密码', en: "Enter password" },
    'match_best': { zh: '最佳搭档', en: "Best Match" },
    'match_similar': { zh: '性格相近', en: "Similar" },
    'match_worst': { zh: '性格相冲', en: "Worst Match" },
    'rarity_common': { zh: '普通', en: "Common" },
    'rarity_epic': { zh: '史诗', en: "Epic" },
    'rarity_legendary': { zh: '传说', en: "Legendary" },
    'rarity_rare': { zh: '稀有', en: "Rare" },
    'rarity_you': { zh: '你的动物是', en: "Your animal is" },
  "animal_cat_desc": {"zh": "你是独立自主的化身，喜欢按自己的节奏生活。表面高冷，内心温暖，只对真正在乎的人展现柔软的一面。充满好奇心，总是对世界保持探索欲。", "en": "You are the embodiment of independence, liking to live at your own pace. Cold on the surface but warm inside, full of curiosity."},
  "animal_cat_keyword": {"zh": "傲娇独立", "en": "Proud Independence"},
  "animal_cat_name": {"zh": "猫", "en": "Cat"},
  "animal_cat_strength": {"zh": "独立自主，适应力强，温柔而有趣", "en": "Independent, adaptable, gentle and fun"},
  "animal_cat_trait_0": {"zh": "独立", "en": "Independent"},
  "animal_cat_trait_1": {"zh": "傲娇", "en": "Tsundere"},
  "animal_cat_trait_2": {"zh": "好奇", "en": "Curious"},
  "animal_cat_weakness": {"zh": "有时显得冷漠，不善表达感情", "en": "Sometimes seems cold, not good at expressing feelings"},
  "animal_dog_desc": {"zh": "你是忠诚与热情的代名词，对在乎的人毫无保留。开朗乐观，总能在朋友需要时带来温暖。直觉敏锐，能第一时间感知你的情绪变化。", "en": "You are synonymous with loyalty and enthusiasm, giving everything to those you care about. Optimistic and cheerful, always bringing warmth."},
  "animal_dog_keyword": {"zh": "忠诚伙伴", "en": "Loyal Companion"},
  "animal_dog_name": {"zh": "狗", "en": "Dog"},
  "animal_dog_strength": {"zh": "忠诚度极高，热情开朗，感知力强", "en": "Extremely loyal, enthusiastic and cheerful, strong perception"},
  "animal_dog_trait_0": {"zh": "忠诚", "en": "Loyal"},
  "animal_dog_trait_1": {"zh": "热情", "en": "Enthusiastic"},
  "animal_dog_trait_2": {"zh": "开朗", "en": "Cheerful"},
  "animal_dog_weakness": {"zh": "过度依赖认可，有时过于讨好", "en": "Over-dependent on approval, sometimes too eager to please"},
  "animal_dolphin_desc": {"zh": "你是快乐与智慧的结合体，总能在社交中找到平衡点。善于沟通，是朋友圈中的开心果和氛围制造者。同时拥有高情商和高智商。", "en": "You are a combination of happiness and wisdom, always finding balance in social situations. You are the mood-maker among friends."},
  "animal_dolphin_keyword": {"zh": "快乐使者", "en": "Happiness Messenger"},
  "animal_dolphin_name": {"zh": "海豚", "en": "Dolphin"},
  "animal_dolphin_strength": {"zh": "社交能力强，情商高，适应力强", "en": "Strong social ability, high EQ, strong adaptability"},
  "animal_dolphin_trait_0": {"zh": "智慧", "en": "Wise"},
  "animal_dolphin_trait_1": {"zh": "友善", "en": "Friendly"},
  "animal_dolphin_trait_2": {"zh": "快乐", "en": "Joyful"},
  "animal_dolphin_weakness": {"zh": "有时为了讨好他人而失去自我", "en": "Sometimes loses self to please others"},
  "animal_dragon_desc": {"zh": "你是人群中的绝对领袖，天生具有吸引他人追随的气场。充满野心与决断力，敢于冒险，渴望站在最高点。你的意志如钢铁，行动如疾风，是天生的改变者。", "en": "You are the absolute leader in any group, naturally attracting others to follow. Ambitious and decisive, you dare to take risks and stand at the top."},
  "animal_dragon_keyword": {"zh": "王者归来", "en": "Return of the King"},
  "animal_dragon_name": {"zh": "龙", "en": "Dragon"},
  "animal_dragon_strength": {"zh": "战略思维极强，决策果断，敢想敢做", "en": "Exceptional strategic thinking, decisive decision-making, bold and action-oriented"},
  "animal_dragon_trait_0": {"zh": "威严", "en": "Dignified"},
  "animal_dragon_trait_1": {"zh": "掌控", "en": "Commanding"},
  "animal_dragon_trait_2": {"zh": "领袖", "en": "Leadership"},
  "animal_dragon_weakness": {"zh": "有时过于强势，容易忽略他人感受", "en": "Sometimes too dominant, can overlook others feelings"},
  "animal_eagle_desc": {"zh": "你拥有超越常人的视野与洞察力，能看到别人看不到的机会与危险。追求自由，不愿被束缚，一旦确定目标便如离弦之箭。你是天生的战略家。", "en": "You have vision and insight beyond ordinary people, able to see opportunities and dangers others cannot. You pursue freedom and are a natural strategist."},
  "animal_eagle_keyword": {"zh": "鹰击长空", "en": "Eagle Takes Flight"},
  "animal_eagle_name": {"zh": "鹰", "en": "Eagle"},
  "animal_eagle_strength": {"zh": "战略眼光极高，执行力强，看透本质", "en": "Extremely high strategic vision, strong execution, sees through essence"},
  "animal_eagle_trait_0": {"zh": "视野", "en": "Visionary"},
  "animal_eagle_trait_1": {"zh": "自由", "en": "Free"},
  "animal_eagle_trait_2": {"zh": "洞察", "en": "Perceptive"},
  "animal_eagle_weakness": {"zh": "有时过于挑剔，缺乏耐心", "en": "Sometimes too critical, lacks patience"},
  "animal_fox_desc": {"zh": "你是机智与魅力的结合体，反应快，社交能力强。善于察言观色，总能在复杂局面中找到最优解。外表与内在同样精彩，让人捉摸不透。", "en": "You are a combination of wit and charm, quick-witted with strong social skills. Good at reading situations and finding optimal solutions."},
  "animal_fox_keyword": {"zh": "机敏狡黠", "en": "Clever Cunning"},
  "animal_fox_name": {"zh": "狐狸", "en": "Fox"},
  "animal_fox_strength": {"zh": "机智灵活，社交能力强，魅力十足", "en": "Witty and flexible, strong social skills, very charming"},
  "animal_fox_trait_0": {"zh": "机智", "en": "Clever"},
  "animal_fox_trait_1": {"zh": "灵活", "en": "Flexible"},
  "animal_fox_trait_2": {"zh": "魅力", "en": "Charming"},
  "animal_fox_weakness": {"zh": "有时过于算计，缺乏真诚", "en": "Sometimes too calculating, lacks sincerity"},
  "animal_kirin_desc": {"zh": "你是吉祥与福气的象征，待人温和，心地善良到极致。智慧与同理心并存，是朋友倾诉时的最佳听众。你的存在本身就能给人带来平静与安心。", "en": "You are a symbol of luck and blessing, gentle and kind at heart. Your wisdom coexists with empathy, making you the best listener when friends need to talk."},
  "animal_kirin_keyword": {"zh": "祥瑞仁心", "en": "Auspicious Heart"},
  "animal_kirin_name": {"zh": "麒麟", "en": "Qilin"},
  "animal_kirin_strength": {"zh": "情商极高，同理心强，温和而有原则", "en": "Extremely high EQ, strong empathy, gentle yet principled"},
  "animal_kirin_trait_0": {"zh": "祥瑞", "en": "Auspicious"},
  "animal_kirin_trait_1": {"zh": "智慧", "en": "Wise"},
  "animal_kirin_trait_2": {"zh": "仁慈", "en": "Benevolent"},
  "animal_kirin_weakness": {"zh": "过度包容，缺乏边界感", "en": "Overly tolerant, lacking boundary awareness"},
  "animal_koala_desc": {"zh": "你是慢生活的代言人，看似慵懒实则有大智慧。懂得在快节奏中保持自我，不争不抢却让人无法忽视你的存在。是个可靠的陪伴者。", "en": "You are the representative of slow living, seeming lazy but having great wisdom. You know how to maintain yourself in a fast-paced world."},
  "animal_koala_keyword": {"zh": "慢享生活", "en": "Slow Living"},
  "animal_koala_name": {"zh": "考拉", "en": "Koala"},
  "animal_koala_strength": {"zh": "心态平和，相处轻松，压力低", "en": "Peaceful mindset, easy to be around, low stress"},
  "animal_koala_trait_0": {"zh": "慢活", "en": "Slow Life"},
  "animal_koala_trait_1": {"zh": "淡定", "en": "Calm"},
  "animal_koala_trait_2": {"zh": "陪伴", "en": "Companion"},
  "animal_koala_weakness": {"zh": "缺乏紧迫感，适应变化较慢", "en": "Lacks urgency, slow to adapt to change"},
  "animal_leopard_desc": {"zh": "你是速度与优雅的完美结合，做事干净利落，从不拖泥带水。独立自主，不依赖他人，同时保持着优雅的气质和生活品味。是个优雅的现实主义者。", "en": "You are the perfect combination of speed and elegance, handling everything efficiently without hesitation. Independent and self-reliant with elegant taste."},
  "animal_leopard_keyword": {"zh": "优雅猎手", "en": "Elegant Hunter"},
  "animal_leopard_name": {"zh": "豹", "en": "Leopard"},
  "animal_leopard_strength": {"zh": "行动效率高，独立自信，品味出众", "en": "Highly efficient, independently confident, excellent taste"},
  "animal_leopard_trait_0": {"zh": "敏捷", "en": "Agile"},
  "animal_leopard_trait_1": {"zh": "优雅", "en": "Elegant"},
  "animal_leopard_trait_2": {"zh": "独立", "en": "Independent"},
  "animal_leopard_weakness": {"zh": "有时冷漠，不善于求助他人", "en": "Sometimes cold, not good at asking for help"},
  "animal_owl_desc": {"zh": "你是深沉的思考者，追求知识与智慧。冷静理性，善于分析问题，能在混乱中保持清醒的头脑。话不多但每一句都有分量。", "en": "You are a deep thinker pursuing knowledge and wisdom. Calm and rational, good at analyzing problems, able to stay clear-headed in chaos."},
  "animal_owl_keyword": {"zh": "智慧之光", "en": "Light of Wisdom"},
  "animal_owl_name": {"zh": "猫头鹰", "en": "Owl"},
  "animal_owl_strength": {"zh": "逻辑清晰，洞察力强，冷静沉着", "en": "Clear logic, strong insight, calm and composed"},
  "animal_owl_trait_0": {"zh": "智慧", "en": "Wise"},
  "animal_owl_trait_1": {"zh": "冷静", "en": "Calm"},
  "animal_owl_trait_2": {"zh": "洞察", "en": "Perceptive"},
  "animal_owl_weakness": {"zh": "过于理性，有时缺乏行动力", "en": "Too rational, sometimes lacks action"},
  "animal_panda_desc": {"zh": "你是天生的治愈系存在，和你在一起会感到莫名的安心。外表呆萌，内心淡定从容，无论外界多喧嚣，你总能保持自己的节奏。", "en": "You are a natural healing presence, people feel inexplicably at ease around you. Cute and calm, you can always maintain your own rhythm."},
  "animal_panda_keyword": {"zh": "治愈萌物", "en": "Healing Cutie"},
  "animal_panda_name": {"zh": "熊猫", "en": "Panda"},
  "animal_panda_strength": {"zh": "情绪稳定，治愈力强，心态平和", "en": "Emotionally stable, strong healing ability, peaceful mindset"},
  "animal_panda_trait_0": {"zh": "治愈", "en": "Healing"},
  "animal_panda_trait_1": {"zh": "淡定", "en": "Calm"},
  "animal_panda_trait_2": {"zh": "萌趣", "en": "Cute"},
  "animal_panda_weakness": {"zh": "缺乏危机意识，竞争意识弱", "en": "Lacks crisis awareness, weak competitive spirit"},
  "animal_phoenix_desc": {"zh": "你拥有在逆境中重生的惊人力量。无论遭遇多大挫折，都能浴火重生。你的热情具有强大的感染力，是朋友圈中的精神领袖，总能激励他人。", "en": "You possess amazing power to rise from adversity. No matter how many setbacks you face, you always rise again. Your passion is infectious."},
  "animal_phoenix_keyword": {"zh": "浴火重生", "en": "Rise from the Ashes"},
  "animal_phoenix_name": {"zh": "凤凰", "en": "Phoenix"},
  "animal_phoenix_strength": {"zh": "抗压能力极强，热情洋溢，感染力惊人", "en": "Extremely high stress tolerance, passionate and infectious"},
  "animal_phoenix_trait_0": {"zh": "重生", "en": "Reborn"},
  "animal_phoenix_trait_1": {"zh": "激情", "en": "Passionate"},
  "animal_phoenix_trait_2": {"zh": "魅力", "en": "Charming"},
  "animal_phoenix_weakness": {"zh": "有时过度付出，燃烧自己照亮他人", "en": "Sometimes gives too much, burning yourself to light others"},
  "animal_rabbit_desc": {"zh": "你是温柔与敏感的结合体，心思细腻，能敏锐地察觉周围人的情绪变化。外表柔弱，内心敏捷，适应力极强。是你朋友圈里的情绪调节师。", "en": "You are a combination of gentleness and sensitivity, detail-oriented and able to sense changes in those around you."},
  "animal_rabbit_keyword": {"zh": "温柔敏锐", "en": "Gentle Sensitivity"},
  "animal_rabbit_name": {"zh": "兔子", "en": "Rabbit"},
  "animal_rabbit_strength": {"zh": "感知力强，善解人意，适应力好", "en": "Strong perception, understanding, good adaptability"},
  "animal_rabbit_trait_0": {"zh": "温柔", "en": "Gentle"},
  "animal_rabbit_trait_1": {"zh": "敏捷", "en": "Agile"},
  "animal_rabbit_trait_2": {"zh": "警觉", "en": "Alert"},
  "animal_rabbit_weakness": {"zh": "敏感多疑，容易焦虑", "en": "Sensitive and suspicious, prone to anxiety"},
  "animal_tiger_desc": {"zh": "你是正义的化身，身上流淌着战士的血液。勇敢无畏，面对不公会毫不犹豫地站出来。你的保护欲极强，是朋友眼中最可靠的后盾。", "en": "You are the embodiment of justice, with warrior blood flowing through your veins. Brave and fearless, you stand up without hesitation when faced with injustice."},
  "animal_tiger_keyword": {"zh": "正义守护", "en": "Guardian of Justice"},
  "animal_tiger_name": {"zh": "白虎", "en": "White Tiger"},
  "animal_tiger_strength": {"zh": "勇敢无畏，正义感强，守护心重", "en": "Brave and fearless, strong sense of justice, protective"},
  "animal_tiger_trait_0": {"zh": "勇猛", "en": "Brave"},
  "animal_tiger_trait_1": {"zh": "正义", "en": "Righteous"},
  "animal_tiger_trait_2": {"zh": "守护", "en": "Protective"},
  "animal_tiger_weakness": {"zh": "有时过于冲动，缺乏耐心", "en": "Sometimes too impulsive, lacks patience"},
  "animal_unicorn_desc": {"zh": "你是独一无二的存在，拥有童话般的纯净心灵。充满创意与想象力，在人群中总是那个最特别的存在。你的出现让周围的一切都变得美好。", "en": "You are a unique existence with a fairy-tale pure heart. Full of creativity and imagination, you are always the most special one in any crowd."},
  "animal_unicorn_keyword": {"zh": "梦幻纯粹", "en": "Pure Dream"},
  "animal_unicorn_name": {"zh": "独角兽", "en": "Unicorn"},
  "animal_unicorn_strength": {"zh": "创意无限，思维独特，审美出众", "en": "Infinite creativity, unique thinking, outstanding aesthetic sense"},
  "animal_unicorn_trait_0": {"zh": "梦幻", "en": "Dreamy"},
  "animal_unicorn_trait_1": {"zh": "纯真", "en": "Pure"},
  "animal_unicorn_trait_2": {"zh": "独特", "en": "Unique"},
  "animal_unicorn_weakness": {"zh": "活在理想世界，现实感稍弱", "en": "Living in an ideal world, slightly weak sense of reality"},
  "animal_whale_desc": {"zh": "你是深沉与包容的化身，内心有着丰富的情感世界。安静却充满力量，不张扬却让人无法忽视。你的情绪稳定，是朋友们的定心丸。", "en": "You are the embodiment of depth and tolerance, with a rich emotional world inside. Quiet yet full of power, not flamboyant but impossible to ignore."},
  "animal_whale_keyword": {"zh": "深沉如海", "en": "Deep as the Ocean"},
  "animal_whale_name": {"zh": "鲸鱼", "en": "Whale"},
  "animal_whale_strength": {"zh": "情绪稳定，胸襟宽广，沉着冷静", "en": "Emotionally stable, broad-minded, calm and composed"},
  "animal_whale_trait_0": {"zh": "深邃", "en": "Deep"},
  "animal_whale_trait_1": {"zh": "包容", "en": "Tolerant"},
  "animal_whale_trait_2": {"zh": "沉稳", "en": "Steady"},
  "animal_whale_weakness": {"zh": "不善于表达情感，有时显得疏离", "en": "Not good at expressing emotions, sometimes seem distant"},
  "animal_wolf_desc": {"zh": "你是天生的团队协作大师，忠诚是你最闪耀的品质。对家人和朋友绝对忠诚，在群体中总是默默承担，却从不计较回报。直觉敏锐，能第一时间察觉危险。", "en": "You are a natural team player, loyalty is your most shining quality. Absolutely loyal to family and friends, you always shoulder responsibilities silently."},
  "animal_wolf_keyword": {"zh": "狼性忠诚", "en": "Loyal Pack"},
  "animal_wolf_name": {"zh": "狼", "en": "Wolf"},
  "animal_wolf_strength": {"zh": "忠诚度高，团队意识强，直觉敏锐", "en": "High loyalty, strong teamwork awareness, keen intuition"},
  "animal_wolf_trait_0": {"zh": "忠诚", "en": "Loyal"},
  "animal_wolf_trait_1": {"zh": "团队", "en": "Team Player"},
  "animal_wolf_trait_2": {"zh": "敏锐", "en": "Keen"},
  "animal_wolf_weakness": {"zh": "过度依赖群体，社交圈固定", "en": "Over-dependent on group, fixed social circle"},
    'reg_placeholder_account': { zh: '设置登录账号', en: "Set login account" },
    'reg_placeholder_city': { zh: '所在城市（选填）', en: "City (optional)" },
    'reg_placeholder_name': { zh: '你的姓名（选填）', en: "Your name (optional)" },
    'reg_placeholder_password': { zh: '至少6位密码', en: "At least 6 characters" },
    'reg_placeholder_phone': { zh: '手机号（选填）', en: "Phone number (optional)" },
    'reg_placeholder_qq': { zh: 'QQ号（选填）', en: "QQ number (optional)" },
    'reg_placeholder_wechat': { zh: '微信号（选填）', en: "WeChat ID (optional)" },
    'result_detail': { zh: '详细解读', en: "Detailed Analysis" },
    
    result_purpose_title: { zh: "测这个有什么用", en: "What's the point?" },
    result_purpose_1: { zh: "了解自己真实的性格倾向", en: "Understand your true behavioral patterns" },
    result_purpose_2: { zh: "找到与你天生合拍的人", en: "Find people you're naturally compatible with" },
    result_purpose_3: { zh: "在职场和社交中少走弯路", en: "Navigate work and social life more effectively" },'select_gender': { zh: '请选择（选填）', en: "Select (optional)" },
    'tab_login': { zh: '登录', en: "Login" },
    'tab_register': { zh: '注册', en: "Register" },
    'traffic_follow_desc': { zh: '回复【动物】获取完整性格报告', en: "Reply【Animal】for your full report" },
    'traffic_follow_title': { zh: '关注公众号', en: "Follow Official Account" },
    'traffic_unlock_title': { zh: '解锁完整版动物分析', en: "Unlock Full Animal Analysis" },
